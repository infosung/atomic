...
description = libs.versions.moduleDescriptionStorage.get()
...
mavenPublishing {
  ...
  signAllPublications()
  coordinates(group.toString(), libs.versions.artifactStorage.get(), version.toString())

  pom {
    name.set(libs.versions.artifactStorage.get())
    description.set(libs.versions.pomDescriptionStorage.get())
