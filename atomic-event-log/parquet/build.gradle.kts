...
description = libs.versions.moduleDescriptionEventLogParquet.get()
...
mavenPublishing {
  ...
  signAllPublications()
  coordinates(group.toString(), libs.versions.artifactEventLogParquet.get(), version.toString())

  pom {
    name.set(libs.versions.artifactEventLogParquet.get())
    description.set(libs.versions.pomDescriptionEventLogParquet.get())
