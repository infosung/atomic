...
description = libs.versions.moduleDescriptionEventLogSpringWeb.get()
...
mavenPublishing {
  ...
  signAllPublications()
  coordinates(group.toString(), libs.versions.artifactEventLogSpringWeb.get(), version.toString())

  pom {
    name.set(libs.versions.artifactEventLogSpringWeb.get())
    description.set(libs.versions.pomDescriptionEventLogSpringWeb.get())
