...
description = libs.versions.moduleDescriptionEventLogIngestApi.get()
...
mavenPublishing {
  ...
  signAllPublications()
  coordinates(group.toString(), libs.versions.artifactEventLogIngestApi.get(), version.toString())

  pom {
    name.set(libs.versions.artifactEventLogIngestApi.get())
    description.set(libs.versions.pomDescriptionEventLogIngestApi.get())
