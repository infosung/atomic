...
This guide explains how the event-log storage side is intended to be composed in `0.1.3`.
...
In the current `0.1.3` collector line, `InMemoryEventLogSpool` is the lighter default recommendation
