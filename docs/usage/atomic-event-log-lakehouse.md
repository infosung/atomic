...
This guide explains how the event-log storage side is intended to be composed in `0.2.0`.
...
In the current `0.2.0` collector line, `InMemoryEventLogSpool` is the lighter default recommendation
