...
- Published artifact equivalents for `v0.2.0` are:
  - version-only: `implementation("com.infosung:atomic.app.version:0.2.0")`
  - image API: `implementation("com.infosung:atomic.starter:0.2.0")`, `implementation("com.infosung:atomic.app.storage.api:0.2.0")`, `implementation("com.infosung:atomic.storage:0.2.0")`
  - oauth redirect relay API: `implementation("com.infosung:atomic.starter:0.2.0")`, `implementation("com.infosung:atomic.app.oauth.redirect:0.2.0")`, `implementation("com.infosung:atomic.spring.oauth2:0.2.0")`
  - event-log ingest API: `implementation("com.infosung:atomic.event.log:0.2.0")`, `implementation("com.infosung:atomic.event.log.parquet:0.2.0")`, `implementation("com.infosung:atomic.event.log.ingest.api:0.2.0")`
  - Spring-free crypto helpers: `implementation("com.infosung:atomic.crypto:0.2.0")`
  - convenience bundle: `implementation("com.infosung:atomic.app:0.2.0")`
...
- If you are upgrading an existing `0.1.x` host, review [Release Migration Guide: `v0.1.2` -> `v0.2.0`](../migration/v0.1.2-to-v0.2.0.md).
