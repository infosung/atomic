...
description = libs.versions.moduleDescriptionSpringIdempotency.get()
...
mavenPublishing {
  ...
  signAllPublications()
  coordinates(group.toString(), libs.versions.artifactSpringIdempotency.get(), version.toString())

  pom {
    name.set(libs.versions.artifactSpringIdempotency.get())
    description.set(libs.versions.pomDescriptionSpringIdempotency.get())
