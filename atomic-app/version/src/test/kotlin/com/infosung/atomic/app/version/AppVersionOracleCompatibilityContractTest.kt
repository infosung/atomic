...
@DataJpaTest(
    properties =
        [
            ...
            "spring.sql.init.schema-locations=classpath:META-INF/atomic/sql/oracle/service_version.sql",
        ],
)
@AutoConfigureTestDatabase(replace = AutoConfigureTestDatabase.Replace.NONE)
@Import(AppVersionOracleCompatibilityContractTest.TestConfiguration::class)
@Testcontainers(disabledWithoutDocker = true)
class AppVersionOracleCompatibilityContractTest {
  ...
  @Test
  fun `oracle asset should support preflight and version check use case`() {
