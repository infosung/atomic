...
description = libs.versions.moduleDescriptionApp.get()
...
mavenPublishing {
  ...
  signAllPublications()
  coordinates(group.toString(), libs.versions.artifactApp.get(), version.toString())

  pom {
    name.set(libs.versions.artifactApp.get())
    description.set(libs.versions.pomDescriptionApp.get())
