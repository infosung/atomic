...
description = libs.versions.moduleDescriptionAppStorageApi.get()
...
mavenPublishing {
  ...
  signAllPublications()
  coordinates(group.toString(), libs.versions.artifactAppStorageApi.get(), version.toString())

  pom {
    name.set(libs.versions.artifactAppStorageApi.get())
    description.set(libs.versions.pomDescriptionAppStorageApi.get())
