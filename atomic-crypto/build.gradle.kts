...
description = libs.versions.moduleDescriptionCrypto.get()
...
mavenPublishing {
  ...
  signAllPublications()
  coordinates(group.toString(), libs.versions.artifactCrypto.get(), version.toString())

  pom {
    name.set(libs.versions.artifactCrypto.get())
    description.set(libs.versions.pomDescriptionCrypto.get())
